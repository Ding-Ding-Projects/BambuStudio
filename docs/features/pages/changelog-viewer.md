...
> The desktop application has its own viewer over the same facts — **Help ▸ What's new / Changelog…** —
> fed by `resources/changelog/changelog.json`, which `scripts/changelog/export-app-changelog.mjs`
> generates with this script's parsing. See [In-app changelog viewer](../windows/changelog-viewer.md).
