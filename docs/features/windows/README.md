...
- [Smart home: printer handover, TTS narrator, alert lights, and settings sync](smart-home.md)
- [Scheduled settings (time windows, HTTPS API, Home Assistant switch)](scheduled-settings.md)
